...
public class DatabaseConnection {
    ...
    private static final String DB_PASSWORD = "Contraseña4Super2Secreta0"; // Reemplaza con tu contraseña
    ...
    private static final String WALLET_PATH = "OtrosRecursos/Wallet_Magicas"; // Reemplaza con tu ruta
    // Nombre del servicio TNS del archivo tnsnames.ora (ej: yourdbname_high)
    private static final String TNS_NAME = "magicaselencuentro_medium"; // Reemplaza con tu TNS Name
